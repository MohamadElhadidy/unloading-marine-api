...
$result1 = mysqli_query($con, "SELECT * FROM cars where car_no ='$car_no' AND vessel_id = '$vessel_id' AND  done = 0 ");
$row = mysqli_fetch_assoc($result1);


if ( $str1 == null or $carn == null )  echo "empty";
elseif (mysqli_num_rows($result1) > 0)  echo "car_no";
else echo $car_no;
?>