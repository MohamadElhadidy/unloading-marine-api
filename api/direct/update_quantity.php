...
<body>
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">إضافة وزن النقله</div>
            <div class="panel-body text-center justify-content-center">
                <form id="myform">
                    ...
                    <button class="btn btn-primary  btn-lg" id='btn-save'>حفظ</button>
                </form>
            </div>
        </div>
    </div>
...
$("#btn-save").click(function(e) {
    $("#myform").validate({
        ...
        submitHandler: function() {
            ...
            $.ajax({
                type: "POST",
                url: '../controllers/quantity_update_direct.php',
                data: formData,
                dataType: "json",
                encode: true,
